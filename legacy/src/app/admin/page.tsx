...
const changev=(e:any)=>{
  ...
  return (
    ...
    <h1 style={{fontSize:29,textAlign:'center',color:'black',fontFamily:'system'}}>welcome khaled</h1>
    <div style={{width:'60'}}>
      
      <img  style={{width:'60%', marginLeft:80,marginBottom:15}} src="https://images.ctfassets.net/23aumh6u8s0i/4Q6uHmPKZjR2XVuIehcO9J/4537716dd5f5d355c8a64c16726f15c0/jwt" alt="" /></div>
  <div className="h-body px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-200">
     <ul className="space-y-2 font-medium">
        ...
        <h1  className="flex items-center p-2 text-gray-900 rounded-lg dark:text-black hover:bg-gray-100 dark:hover:bg-white-700 group">
              ...
              <span className="flex-1 ms-3 whitespace-nowrap"onClick={()=>{changev('client')}}> Our client </span>
           </h1>
        </li>
